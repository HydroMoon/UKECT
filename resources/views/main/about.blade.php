  ...
  <div class="row">
      <div class="col-sm mx-auto m-2">
          <div class="card">
            ...
            <div class="card-body">
              <h3>روئية المركز</h3>
              <p><ul>تطوير التدريب بشقيه التقني والإداري وفقاً لمواصفات الجودة الشاملة.</ul></p>
              <br>
              <h3>رسالة المركز</h3>
              <p><ul>تقديم برامج تدريبية عالية المستوي يكون لها أثر فعال في ترقية المهن المختلفة وتلبية حاجات السوق.</ul></p>
              <h3>أهداف المركز</h3>
              <p>
                  <ul>إعداد كادر مؤهل يتميز بمهارات تخصصيه عالية من خلال التدريب المكثف.</ul>
                  <ul>تقديم نظم تدريبيه تتميز بالكفاءة وسرعة الانجاز.</ul>
