...
<link media="all" type="text/css" rel="stylesheet" href="{{ asset('css/social-share-kit.css') }}">
<link media="all" type="text/css" rel="stylesheet" href="{{ asset('css/ekko-lightbox.css') }}">
